...
# we will start with a simple score sum across the 63 game rounds

def oneshot():
        final = []
        for run in listdir(basebasedir): 
                strat_sums = { 
                        'TitForTat' :    {'sum' : 0, 'sumVsGrimTrigger' : 0, 'sumVsAlwaysDefect' : 0, 'sumVsRandomDefect' : 0 , 'sumVsTitForTat' : 0 , 'chance' : 0} , 
                        'GrimTrigger' :  {'sum' : 0, 'sumVsGrimTrigger' : 0, 'sumVsAlwaysDefect' : 0, 'sumVsRandomDefect' : 0 , 'sumVsTitForTat' : 0, 'chance' : 0} , 
                        'AlwaysDefect' : {'sum' : 0, 'sumVsGrimTrigger' : 0, 'sumVsAlwaysDefect' : 0, 'sumVsRandomDefect' : 0 , 'sumVsTitForTat' : 0 , 'chance' : 0 } ,
                        'RandomDefect' : {'sum' : 0, 'sumVsGrimTrigger' : 0, 'sumVsAlwaysDefect' : 0, 'sumVsRandomDefect' : 0 , 'sumVsTitForTat' : 0, 'chance' : 0} }
...
#print(TitForTat,GrimTrigger,AlwaysDefect,RandomDefect)
